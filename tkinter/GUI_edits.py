...
label1 = Label(tab1, text= 'Product Service Code Recommendation Engine',padx=5, pady=5,font="Verdana 10 bold")
label1.grid(row=1,column=0)

S1Lb1 = Label(tab1, text="Order Title", fg="black", bg="white")
...
S1Lb2 = Label(tab1, text="Line Description", fg="black", bg="white")
...
S1Lb5 = Label(tab1, text="Select Other Product Service Code", fg="black", bg="white")
...
S1Lb6 = Label(tab1, text="Edited PSC Status", fg="black", bg="white")
S1Lb6.grid(row=12, column=0, padx=5,pady=5,sticky=W+E)
result_display = Text(tab1,height=2, width=40)
result_display.grid(row=12, column=1,padx=10,sticky=W)
...
### BUTTON ###
clear_input1=tk.Button(tab1,text="Clear Input",command=clear_text1, activebackground = 'white')
clear_input1.grid(row=2, column=2, padx=5, pady=5,sticky=W+E)
clear_input2=tk.Button(tab1,text="Clear Input",command=clear_text2, activebackground = 'white')
...
lookupbutton=tk.Button(tab1,text="Generate Recommendation",command=lambda:[clickOK(),action1(),predict_psc()], activebackground = 'white') # I think this is how to incorporate cleaning with recommendation (Added action1())
lookupbutton.grid(row=6, column=2, padx=0, pady=0,sticky=W+E)
correctbutton=tk.Button(tab1,text="Accept Recommendation",command=click1, activebackground = 'white')
...
clear_result=tk.Button(tab1,text="Clear Recommendation",command=clear_result, activebackground = 'white')
clear_result.grid(row=7, column=2, padx=5, pady=5,sticky=W+E)
clear_edited_record=tk.Button(tab1,text="Clear PSC Input",command=clear_edited, activebackground = 'white')
